...
> material between two files (VUVA + VFE). The split was historical —
> VFE staged Diakrisis-preprint-gated extensions ahead of their
...
> `foundational-extensions.md`) are removed; external citations of "VUVA
> §X.Y" and "VFE-N" continue to refer to the same material, now under a
