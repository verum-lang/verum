...
check-diagnostic-levers: ## Gate (T1385): a VERUM_* lever whose VALUE is a name pattern must be on the levers page
	python3 scripts/ci/check_diagnostic_levers.py --self-test
	python3 scripts/ci/check_diagnostic_levers.py
