...
| `text/text`              | 1014|  348|  235|  290| 16 (§A rfind dispatch / §B Char.encode_utf8 receiver-kind / **§C CLOSED 2026-05-13 commit `48a76117f` + `5d04b98e7` — Iterator.next dispatch + utf8_decode_char 2-arg fix; 14 tests flipped green: 121→135/218 sweep** / §D function-id collision / §E truncate NullPointer / §F KMP find byte-indexing / §G–§Q downstream / §R count_matches typechecker ICE). Status promoted **regression-only → partial**. |
