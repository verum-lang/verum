...
| `text/text`              | 1014|  348|  235|  290| 17 (§A rfind dispatch / §B Char.encode_utf8 receiver-kind / **§C CLOSED 2026-05-13 commit `48a76117f` — Iterator.next dispatch + 8 iterator tests flipped green** / §D function-id collision / §E truncate NullPointer / §F KMP find byte-indexing / §G–§Q downstream / §R count_matches typechecker ICE). Status promoted **regression-only → partial**. |
