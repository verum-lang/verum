...
> [CLOSURE-RESULT-1](docs/architecture/defect-class-catalogue.md#3-closure-via--chain-on-result--maybe),
...
> [TRANSIENTMUT-1](docs/architecture/defect-class-catalogue.md#5-transient-mut-self-propagation-through-nested-method-calls)
> pattern.
