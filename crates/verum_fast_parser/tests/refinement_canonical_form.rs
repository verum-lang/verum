...
//! Regression tests for the VUVA §5 refinement-type canonicalisation.
//!
//! Per VUVA §5 the three surface forms for refinement types all collapse onto
        ...
        TypeKind::Refined { ref predicate, .. } => {
            ...
            match &predicate.expr.kind {
                ...
                other => {
                    ...
                    // node is Refined — which is the VUVA §5 invariant.
                    let _ = other;
                }
            }
        }
...
/// `TypeKind::Refined`. Pins the VUVA §5 structural invariant.
#[test]
