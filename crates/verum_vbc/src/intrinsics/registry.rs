...
static ALL_INTRINSICS: &[Intrinsic] = &[
    ...
    Intrinsic {
        name: "script_outcome_map_len",
        category: IntrinsicCategory::Scripting,
        hints: &[IntrinsicHint::SideEffect],
        param_count: 1, // outcome
        return_count: 1,
        strategy: CodegenStrategy::ExtendedSubOp(
            crate::instruction::ExtendedSubOpcode::ScriptOutcomeMapLen,
        ),
        mlir_op: None,
        doc: "Host: entry count of a Map outcome value",
    },
    Intrinsic {
        name: "script_outcome_map_key_kind",
        category: IntrinsicCategory::Scripting,
        hints: &[IntrinsicHint::SideEffect],
        param_count: 2, // outcome, idx
        return_count: 1,
        strategy: CodegenStrategy::ExtendedSubOp(
            crate::instruction::ExtendedSubOpcode::ScriptOutcomeMapKeyKind,
        ),
        mlir_op: None,
        doc: "Host: kind tag of Map entry i's key",
    },
    Intrinsic {
        name: "script_outcome_map_key_int",
        category: IntrinsicCategory::Scripting,
        hints: &[IntrinsicHint::SideEffect],
        param_count: 2,
        return_count: 1,
        strategy: CodegenStrategy::ExtendedSubOp(
            crate::instruction::ExtendedSubOpcode::ScriptOutcomeMapKeyInt,
        ),
        mlir_op: None,
        doc: "Host: Map entry i's key as Int",
    },
    Intrinsic {
        name: "script_outcome_map_key_float",
        category: IntrinsicCategory::Scripting,
        hints: &[IntrinsicHint::SideEffect],
        param_count: 2,
        return_count: 1,
        strategy: CodegenStrategy::ExtendedSubOp(
            crate::instruction::ExtendedSubOpcode::ScriptOutcomeMapKeyFloat,
        ),
        mlir_op: None,
        doc: "Host: Map entry i's key as Float",
    },
    Intrinsic {
        name: "script_outcome_map_key_bool",
        category: IntrinsicCategory::Scripting,
        hints: &[IntrinsicHint::SideEffect],
        param_count: 2,
        return_count: 1,
        strategy: CodegenStrategy::ExtendedSubOp(
            crate::instruction::ExtendedSubOpcode::ScriptOutcomeMapKeyBool,
        ),
        mlir_op: None,
        doc: "Host: Map entry i's key as Bool",
    },
    Intrinsic {
        name: "script_outcome_map_key_text",
        category: IntrinsicCategory::Scripting,
        hints: &[IntrinsicHint::SideEffect],
        param_count: 2,
        return_count: 1,
        strategy: CodegenStrategy::ExtendedSubOp(
            crate::instruction::ExtendedSubOpcode::ScriptOutcomeMapKeyText,
        ),
        mlir_op: None,
        doc: "Host: Map entry i's key as Text",
    },
    Intrinsic {
        name: "script_outcome_map_value_kind",
        category: IntrinsicCategory::Scripting,
        hints: &[IntrinsicHint::SideEffect],
        param_count: 2,
        return_count: 1,
        strategy: CodegenStrategy::ExtendedSubOp(
            crate::instruction::ExtendedSubOpcode::ScriptOutcomeMapValueKind,
        ),
        mlir_op: None,
        doc: "Host: kind tag of Map entry i's value",
    },
    Intrinsic {
        name: "script_outcome_map_value_int",
        category: IntrinsicCategory::Scripting,
        hints: &[IntrinsicHint::SideEffect],
        param_count: 2,
        return_count: 1,
        strategy: CodegenStrategy::ExtendedSubOp(
            crate::instruction::ExtendedSubOpcode::ScriptOutcomeMapValueInt,
        ),
        mlir_op: None,
        doc: "Host: Map entry i's value as Int",
    },
    Intrinsic {
        name: "script_outcome_map_value_float",
        category: IntrinsicCategory::Scripting,
        hints: &[IntrinsicHint::SideEffect],
        param_count: 2,
        return_count: 1,
        strategy: CodegenStrategy::ExtendedSubOp(
            crate::instruction::ExtendedSubOpcode::ScriptOutcomeMapValueFloat,
        ),
        mlir_op: None,
        doc: "Host: Map entry i's value as Float",
    },
    Intrinsic {
        name: "script_outcome_map_value_bool",
        category: IntrinsicCategory::Scripting,
        hints: &[IntrinsicHint::SideEffect],
        param_count: 2,
        return_count: 1,
        strategy: CodegenStrategy::ExtendedSubOp(
            crate::instruction::ExtendedSubOpcode::ScriptOutcomeMapValueBool,
        ),
        mlir_op: None,
        doc: "Host: Map entry i's value as Bool",
    },
    Intrinsic {
        name: "script_outcome_map_value_text",
        category: IntrinsicCategory::Scripting,
        hints: &[IntrinsicHint::SideEffect],
        param_count: 2,
        return_count: 1,
        strategy: CodegenStrategy::ExtendedSubOp(
            crate::instruction::ExtendedSubOpcode::ScriptOutcomeMapValueText,
        ),
        mlir_op: None,
