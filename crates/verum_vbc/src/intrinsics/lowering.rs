...
impl IntrinsicLowering {
    ...
    fn lower_inline_sequence(
        ...
        match seq_id {
            ...
            // T0108 plain raw twins — same ops, no volatile attribute.
            InlineSequenceId::PtrReadRaw => self.emit(MlirOp {
                name: "llvm.load".to_string(),
                attrs: vec![],
                result_types: vec![MlirType::I64],
                operands: operands.to_vec(),
            ...
            InlineSequenceId::PtrWriteRaw => self.emit(MlirOp {
                name: "llvm.store".to_string(),
                attrs: vec![],
                result_types: vec![],
                operands: operands.to_vec(),
            ...
            // this path is "not the interpreter". Wire code 3 = AOT
            // per the stdlib contract (tier.vr: 0=interp, 1/2=JIT,
            // 3=AOT).
            InlineSequenceId::ExecutionTier => self.emit(MlirOp {
                name: "arith.constant".to_string(),
                attrs: vec![MlirAttr {
                    name: "value".to_string(),
                    value: MlirAttrValue::Integer(3),
                }],
                result_types: vec![MlirType::I64],
                operands: vec![],
                region: None,
            ...
            InlineSequenceId::TextAsBytes => self.emit(MlirOp {
                name: "llvm.call".to_string(),
                attrs: vec![MlirAttr {
                    name: "callee".to_string(),
                    value: MlirAttrValue::String("verum_text_as_bytes".to_string()),
                }],
                result_types: vec![MlirType::Ptr],   // returns FatRef-like pointer
                operands: operands.to_vec(),
                region: None,
            }),
            ...
            InlineSequenceId::CbgrAdvanceEpoch => self.emit(MlirOp {
                name: "verum.cbgr.advance_epoch".to_string(),
                attrs: vec![],
                result_types: vec![],
                operands: operands.to_vec(),
                region: None,
