    ...
    pub fn get_element_f64(&self, index: usize) -> Option<f64> {
        ...
        unsafe {
            ...
            match self.dtype {
                ...
                DType::U8 => Some(*((ptr as *const u8).add(index)) as f64),
                ...
                DType::Bool => Some(if *((ptr as *const u8).add(index)) != 0 { 1.0 } else { 0.0 }),
