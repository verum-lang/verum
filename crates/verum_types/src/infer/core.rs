...
impl TypeChecker {
    ...
    pub fn new() -> Self {
        let mut checker = Self {
            ...
            declared_meta_macros: std::collections::HashSet::new(),
            ...
            lenient_method_reported: std::collections::HashSet::new(),
            pending_arity_mismatch: None,
            ...
            meta_param_refinements: std::collections::HashMap::new(),
