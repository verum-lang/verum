// LLVM 21 uses opaque pointers - always use GEP2 variants
use verum_llvm_sys::core::{LLVMConstGEP2, LLVMConstInBoundsGEP2};

use verum_llvm_sys::core::{LLVMConstAddrSpaceCast, LLVMConstPointerCast, LLVMConstPtrToInt};
