...
pub unsafe trait AggregateValue<'ctx>: BasicValue<'ctx> {
    ...
    // Note: const_extract_value and const_insert_value were removed because
    // LLVMConstExtractValue and LLVMConstInsertValue were removed in LLVM 17+.
    // Use Builder::build_extract_value and build_insert_value instead.
}
