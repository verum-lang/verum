use verum_llvm_sys::core::{LLVMConstReal, LLVMConstRealOfStringAndSize, LLVMGetTypeKind};
use verum_llvm_sys::execution_engine::LLVMCreateGenericValueOfFloat;
...
impl<'ctx> FloatType<'ctx> {
    ...
    pub fn get_bit_width(self) -> u32 {
        ...
        match type_kind {
            verum_llvm_sys::LLVMTypeKind::LLVMHalfTypeKind => 16,
            verum_llvm_sys::LLVMTypeKind::LLVMBFloatTypeKind => 16,
