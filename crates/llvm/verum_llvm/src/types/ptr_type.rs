use verum_llvm_sys::core::LLVMGetPointerAddressSpace;

use verum_llvm_sys::core::LLVMPointerTypeIsOpaque;
...
impl<'ctx> PointerType<'ctx> {
    ...
    /// for other types; provided directly here for convenience.
