...
use verum_llvm_sys::debuginfo::LLVMDIBuilderCreateTypedef;
pub use verum_llvm_sys::debuginfo::LLVMDWARFTypeEncoding;
use verum_llvm_sys::debuginfo::LLVMDebugMetadataVersion;
use verum_llvm_sys::debuginfo::LLVMDisposeDIBuilder;
use verum_llvm_sys::debuginfo::LLVMMetadataReplaceAllUsesWith;
use verum_llvm_sys::debuginfo::LLVMTemporaryMDNode;
...
impl<'ctx> DebugInfoBuilder<'ctx> {
    pub(crate) fn new(
        ...
        // LLVM 11+ requires sysroot and sdk parameters
        sysroot: &str,
        sdk: &str,
...
pub use flags::*;
mod flags {
    pub use verum_llvm_sys::debuginfo::LLVMDIFlags as DIFlags;
    use verum_llvm_sys::debuginfo::{LLVMDWARFEmissionKind, LLVMDWARFSourceLanguage};
    ...
    impl DIFlagsConstants for DIFlags {
        const ZERO: DIFlags = verum_llvm_sys::debuginfo::LLVMDIFlagZero;
        const PRIVATE: DIFlags = verum_llvm_sys::debuginfo::LLVMDIFlagPrivate;
        const PROTECTED: DIFlags = verum_llvm_sys::debuginfo::LLVMDIFlagProtected;
        const PUBLIC: DIFlags = verum_llvm_sys::debuginfo::LLVMDIFlagPublic;
        const FWD_DECL: DIFlags = verum_llvm_sys::debuginfo::LLVMDIFlagFwdDecl;
        const APPLE_BLOCK: DIFlags = verum_llvm_sys::debuginfo::LLVMDIFlagAppleBlock;
        const VIRTUAL: DIFlags = verum_llvm_sys::debuginfo::LLVMDIFlagVirtual;
        const ARTIFICIAL: DIFlags = verum_llvm_sys::debuginfo::LLVMDIFlagArtificial;
        const EXPLICIT: DIFlags = verum_llvm_sys::debuginfo::LLVMDIFlagExplicit;
        const PROTOTYPED: DIFlags = verum_llvm_sys::debuginfo::LLVMDIFlagPrototyped;
        const OBJC_CLASS_COMPLETE: DIFlags = verum_llvm_sys::debuginfo::LLVMDIFlagObjcClassComplete;
        const OBJECT_POINTER: DIFlags = verum_llvm_sys::debuginfo::LLVMDIFlagObjectPointer;
        const VECTOR: DIFlags = verum_llvm_sys::debuginfo::LLVMDIFlagVector;
        const STATIC_MEMBER: DIFlags = verum_llvm_sys::debuginfo::LLVMDIFlagStaticMember;
        const LVALUE_REFERENCE: DIFlags = verum_llvm_sys::debuginfo::LLVMDIFlagLValueReference;
