...
use verum_llvm_sys::core::LLVMGetVersion;
use verum_llvm_sys::core::{LLVMCreateMessage, LLVMDisposeMessage};
use verum_llvm_sys::error_handling::LLVMEnablePrettyStackTrace;
use verum_llvm_sys::support::{LLVMLoadLibraryPermanently, LLVMSearchForAddressOfSymbol};
...
pub unsafe fn shutdown_llvm() {
    use verum_llvm_sys::core::LLVMShutdown;
