...
/* Disabled: tblgen produces "error: invalid conversion from Invalid to alloc::string::String"
   when generating the AMDGPU dialect bindings. Likely an upstream tblgen codegen bug.
verum_mlir_macro::dialect! {
    name: "amdgpu",
