...
mod tests {
    ...
    // MLIR C API does not expose attribute type_id/is_opaque correctly for parsed attributes.
    #[ignore = "MLIR C API limitation: type_id not reliable for parsed attributes"]
    #[test]
    fn type_id() {
        let context = Context::new();
