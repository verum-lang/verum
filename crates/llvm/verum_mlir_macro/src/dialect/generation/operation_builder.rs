...
pub fn generate_operation_builder(builder: &OperationBuilder) -> TokenStream {
    ...
    quote! {
        ...
        pub struct #identifier<'c, #(#type_parameters),*> {
            builder: ::verum_mlir::ir::operation::OperationBuilder<'c>,
            context: &'c ::verum_mlir::Context,
...
/// Generates a builder setter method for a single field. Uses the OperationField
/// trait to dispatch between operands, results, attributes, and successors.
...
fn generate_new_fn(builder: &OperationBuilder) -> TokenStream {
    ...
    quote! {
        impl<'c> #identifier<'c, #(#arguments),*> {
            pub fn new(context: &'c ::verum_mlir::Context, location: ::verum_mlir::ir::Location<'c>) -> Self {
                Self {
                    context,
                    builder: ::verum_mlir::ir::operation::OperationBuilder::new(#name, location),
                    _state: Default::default(),
                }
            }
        }
...
pub fn generate_operation_builder_fn(builder: &OperationBuilder) -> TokenStream {
    ...
    quote! {
        ...
        pub fn builder(
            context: &'c ::verum_mlir::Context,
            location: ::verum_mlir::ir::Location<'c>
...
pub fn generate_default_constructor(builder: &OperationBuilder) -> TokenStream {
    ...
    let arguments = builder
        ...
        .chain([quote! { location: ::verum_mlir::ir::Location<'c> }])
        .collect::<Vec<_>>();
    ...
    quote! {
        ...
        #[doc = #doc]
        pub fn #constructor_identifier<'c>(context: &'c ::verum_mlir::Context, #(#arguments),*) -> #operation_identifier<'c> {
