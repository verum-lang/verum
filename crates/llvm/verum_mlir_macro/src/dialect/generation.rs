...
pub fn generate_operation(operation: &Operation) -> TokenStream {
    ...
    quote! {
        ...
        pub struct #identifier<'c> {
            operation: ::verum_mlir::ir::operation::Operation<'c>,
        }
        ...
        impl<'c> #identifier<'c> {
            ...
            pub fn as_operation(&self) -> &::verum_mlir::ir::operation::Operation<'c> {
                &self.operation
            }
        ...
        impl<'c> TryFrom<::verum_mlir::ir::operation::Operation<'c>> for #identifier<'c> {
            type Error = ::verum_mlir::Error;

            fn try_from(
                operation: ::verum_mlir::ir::operation::Operation<'c>,
                ) -> Result<Self, Self::Error> {
                // Accepts any operation; name validation deferred to MLIR verifier pass.
                Ok(Self { operation })
            }
        }

        impl<'c> From<#identifier<'c>> for ::verum_mlir::ir::operation::Operation<'c> {
