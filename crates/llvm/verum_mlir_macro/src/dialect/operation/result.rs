...
impl OperationField for OperationResult<'_> {
    ...
    // Mirrors Operand::parameter_type; shared via FieldKind trait constraint patterns.
    fn parameter_type(&self) -> Type {
        let r#type: Type = parse_quote!(::verum_mlir::ir::Type<'c>);
    ...
    // Mirrors Operand::return_type; shared via FieldKind trait constraint patterns.
    fn return_type(&self) -> Type {
        let r#type: Type = parse_quote!(::verum_mlir::ir::operation::OperationResult<'c, '_>);
