...
/// `core/mod.vr` text at compilation time — the legacy
/// `extract_prelude_paths` / `strip_comments` scanners that did
/// the live regex-free walk were retired alongside the
/// `embedded_stdlib::get_embedded_stdlib()` source archive.
