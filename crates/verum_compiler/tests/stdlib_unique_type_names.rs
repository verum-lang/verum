...
const BASELINE_DUPLICATES: &[&str] = &[
    ...
    "Cursor", "DbError", "DeadlineTimer", "Decision",
    "Destructor", "Direction",
    "DType", "Duration", "DynamicTable", "Edge", "Effect",
    "ElementType", "Empty", "EnginePhase", "ErrorMessage", "Event",
    "ExceptionFrame", "ExecutionEnv", "ExecutionEnvOpaque",
    "ExecutorHandle", "ExportResult", "Expr", "Fault",
    "FaultSchedule", "Features", "FilterCheck", "FkAction", "Form",
    "Formatter", "Frame", "FrameHeader", "FrameRecord",
    "FutureHandle", "Gauge", "Generator", "Goal", "H3Frame", "HeaderField",
    "HealthStatus", "Histogram", "HistogramSnapshot", "InitError",
    "InlineCircuitBreaker", "InlineRetryPolicy", "Inputs", "Instant",
    "IntegrityReport", "Interval", "IoCqe", "IoDriver", "IoDriverError",
    "IODriverHandle", "IoError", "IoOp", "IoOpKind", "IoToken", "IpMreq",
    "IsolationLevel", "JoinHandle", "JoinHandleOpaque", "JoinKind",
    "JournalMode", "Json", "JsonValue", "KanDirection",
    "KanExtensionResult", "Keyword", "Kind", "Layout", "LeafEntry",
    "LexError", "Lifetime", "LimitClause", "Listener", "Literal",
    "LocalHeap", "LockRegion", "LogLevel", "LogRecord", "LookupOutcome",
    "MapEntry", "MaximalSieve", "MemoryOrder", "MemoryOrdering",
    "MergeAction", "Message", "Metadata", "Method", "MethodSet",
    "MiddlewareChainOpaque", "Mode", "Modifier", "Mutex", "Node",
    "ObstructionData", "ObstructionPoint", "Once", "OnConflict", "Op",
    "Opcode", "OpenMode", "Operand", "Operator", "OpStream",
    "OtlpExporter", "Outcome", "PageCache", "PageHeader", "PageKind",
    "PanicInfo", "ParamForm", "ParamKind", "ParamSpec", "ParsedUri",
    "ParseError", "ParseState", "Patch", "Path", "Pattern",
    "PerfCounter", "Phase", "PipelineReport", "PlanError",
    "PlatformIOEngine", "PorterTokenizer", "Position",
    "PrimaryCode", "Prop", "QueryParam", "QuicStream",
    "Reading", "ReadOnly", "ReadyFuture", "Reason", "RecordError",
    "RecoveryContextOpaque", "RecoveryError", "RecoveryStrategy",
    "RecvError", "Register", "Registration", "Registry", "Request",
    "Resolution", "Resource", "RestartPolicy", "RestartStrategy",
    ...
    "Span", "SpanKind", "SpanStatus", "SpawnConfig",
    "SpinLock", "Split", "SqliteValue", "StackAllocator",
    "Stat", "Stat1Row", "State", "Statement", "StaticEntry", "StatusCode",
    "StepOutcome", "StepResult", "StmtKind", "Stopwatch", "Strategy",
    "StreamError", "Subscription", "Subsystem", "SupervisionStrategy",
    "SupervisorHandleOpaque", "SyncMode", "SystemTime",
    "TableRef", "TaskHandle", "TaskId", "Tensor", "TensorId",
    "TextEncoding", "Thread", "ThreadControlBlock", "ThreadError",
    "ThreadFn", "ThreadId", "ThreadPool", "Time", "Timeout",
    "TimeoutError", "Timespec", "Timeval", "TlsError", "Token",
    "TokenKind", "TraceEvent", "TriggerEvent",
