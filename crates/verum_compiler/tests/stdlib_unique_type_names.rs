...
const BASELINE_DUPLICATES: &[&str] = &[
    ...
    "RetryConfig", "Role", "Router", "Row", "RowShape",
    ...
    "Stat", "State", "Statement", "StaticEntry", "StatusCode",
    "StepOutcome", "StepResult", "StmtKind", "Stopwatch", "Strategy",
    "StreamError", "Subscription", "SupervisionStrategy",
    "SupervisorHandleOpaque", "SyncMode", "SystemTime",
    "TaskHandle", "TaskId", "Tensor", "TensorId",
