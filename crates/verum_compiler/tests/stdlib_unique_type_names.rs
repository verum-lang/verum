...
const BASELINE_DUPLICATES: &[&str] = &[
    ...
    "ExecutorHandle", "Expr", "Fault",
    "Frame",
    "FutureHandle",
    "Instant",
    "IoCqe", "IoDriver", "IoDriverError",
    "IODriverHandle", "IoError", "IoOp", "IoOpKind", "IoToken", "IpMreq",
    "IsolationLevel", "JoinHandleOpaque",
    "Literal",
    "LocalHeap", "LogLevel", "LogRecord",
    "Message", "Method", "MethodSet",
    "MiddlewareChainOpaque", "Mode", "Modifier", "Mutex",
    "Once", "Op",
    "Outcome", "PageHeader",
