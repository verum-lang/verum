//! Method-dispatch receiver-type-narrowing guardrail (#169 / VUVA-153).
//!
...
//! the receiver expression's shape; before VUVA-153 the catch-all fell
...
fn assert_dispatch_panic(scenario: &str, fixture: &std::path::Path) {
    ...
    assert!(
        ...
        "method-dispatch contract `{}` regressed.  vtest did not \
         ...
         Check VUVA-153 fix: the safety net after the giant \
