...
impl TheoremSpec {
    ...
    pub fn with_translated_proof_body(mut self, body: &verum_ast::decl::ProofBody) -> Self {
        use super::proof_body_translate::{
            AgdaProofBodyRenderer, CoqProofBodyRenderer, LeanProofBodyRenderer,
            ProofBodyRenderer, TranslatedProofBody,
        };
        for renderer in [
...
mod tests {
    ...
    #[test]
    fn all_corpus_backends_returns_three_known_backends() {
